...
function getWelcomeResponse(callback) {
    ...
    const speechOutput = 'Welcome to the Alexa Skills Kit sample. ' +
        'You can get the status of all airplanes by saying, give me a full status report.';
...
function moveAirplaneInSession(intent, session, callback) {
    ...
    if (airplaneSlot) {
        ...
        speechOutput = `Airplane ${airplane} has been made to ${action}. You can get the ` +
...
function onIntent(intentRequest, session, callback) {
    ...
    if (intentName === 'MoveAirplaneIntent') {
        moveAirplaneInSession(intent, session, callback);
